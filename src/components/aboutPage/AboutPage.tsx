  ...
  return (
    <main className="main">
        <h1 className={styles.mainTitle}>
          ...
          I'm Juan Pablo, a software developer specialized in frontend with over 10 years of experience in the industry.
          </h2>
          <div className={styles.intro}>
          <p>I'm passionate about creating elegant and functional user interfaces that improve user experience and bring designs to life.</p>
